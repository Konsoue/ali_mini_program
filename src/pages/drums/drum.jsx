...
function Drums(props) {
  const { clickDom } = props

  return (
    <div id="container-drums" className="container-drums screen-sm-hidden">
      <svg version="1.1"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 790" preserveAspectRatio="xMidYMid meet">
        <g id="Drums">
          <path id="Drum-Shadow"
            d="M999.77,656.9c0,36.16-223.73,65.48-499.77,65.48S0.23,693.06.23,656.9,224,591.42,500,591.42,999.77,620.65,999.77,656.9Z"
            transform="translate(-0.23)" fill="#b0bcc5"></path>
          ...
          <g id="Snare" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path d="M840.5,345.29H658.84" transform="translate(-0.23)" fill="none" stroke="#161E54"
              strokeMiterlimit="10" strokeWidth="8"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M718,393.45v-11m0-30.42v-11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M724.75,375.71a6.76,6.76,0,0,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M781.36,393.45v-11m0-30.42v-11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M788.12,375.71a6.76,6.76,0,0,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>


            <path d="M647,320.79H850.64v17.74H647V320.79Zm0,75.2H850.64v17.74H647V396Z" transform="translate(-0.23)"
              fill="#eefaf9" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M650.4,333.46H847.26M650.4,408.66H847.26" transform="translate(-0.23)" fill="none"
              stroke="#bcece8" strokeMiterlimit="10" strokeWidth="4"></path>


            <path d="M741.65,491.46H756v80.27H741.65V491.46Z" transform="translate(-0.23)" fill="#eefaf9"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M804.42,631.55l-56.78-56.78" transform="translate(-0.23)" fill="none" stroke="#bcece8"
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#5c5c5c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M694.84,631.55l54.75-54.84" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <path d="M647.86,400.72a5.49,5.49,0,1,0-11,0V411.2h11V400.72Z" transform="translate(-0.23)"
              fill="#5c5c5c" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M647.86,415.67V411.2h-11v8.45c0,3,2.11,6,5.15,6.34l103.33,11.49,1-10.9-98.52-10.9h0Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M642.54,423.53l100.38,11.24,0.17-1.69L640.34,421.59a2.86,2.86,0,0,0,2.2,1.94h0Z"
            ...
            <path d="M756.35,432.91l0.17,1.69L856,423.53a2.88,2.88,0,0,0,2.11-1.61Z"
              transform="translate(-0.23)" fill="#bcece8"></path>
            <path d="M860.78,400.72a5.49,5.49,0,1,0-11,0V411.2h11V400.72Z" transform="translate(-0.23)"
              fill="#5c5c5c" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6">
            </path>


            <path d="M744,432.3l11,0.06-0.36,63.37-11-.06Z" transform="translate(-0.23)" fill="#eefaf9"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            <circle cx="749.44" cy="432.15" r="7.18" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
            <circle cx="749.44" cy="432.15" r="1.69" fill="#333"></circle>

            <path
              d="M823.86,421.84a5.48,5.48,0,0,0-7.77-.08l-70.8,70,7.69,7.77,70.8-70A5.38,5.38,0,0,0,823.86,421.84Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M815.83,432.32l-54.67,54.07" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="2"></path>
            <circle cx="820.42" cy="424.55" r="7.18" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
            <circle cx="820.42" cy="424.55" r="1.69" fill="#333"></circle>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M679.71,427.25l58.55,59.14" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="2"></path>
            <circle cx="680.16" cy="424.55" r="7.18" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
            <circle cx="680.16" cy="424.55" r="1.69" fill="#333"></circle>
          ...
          <g id="Floor-Tom" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path d="M160.34,314.87H402.83V585.25H160.34V314.87Z" transform="translate(-0.23)" fill="#0F52BA"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M399.45,339.38H163.72" transform="translate(-0.23)" fill="none" stroke="#161E54"
              strokeMiterlimit="10" strokeWidth="8"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M241.45,343.6v-11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M248.21,367.26a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M321.72,343.6v-11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M328.48,367.26a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M152.74,314.87H409.59v17.74H152.74V314.87Z" transform="translate(-0.23)" fill="#eefaf9"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M321.72,556.52v11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M328.48,549.76a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M241.45,556.52v11" transform="translate(-0.23)" fill="none" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M248.21,549.76a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M153.58,567.51H410.44v17.74H153.58V567.51Z" transform="translate(-0.23)" fill="#eefaf9"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M157,580.18h250.1" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#5c5c5c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M170.48,429.78a8.88,8.88,0,0,0-17.74,0v49h17.74v-49Z" transform="translate(-0.23)"
              fill="#eefaf9" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M278.63,630.62a4.73,4.73,0,0,0,4.65,4.82,4.67,4.67,0,0,0,4.65-4.82V477.1h-9.29V630.62Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path
              ...
              transform="translate(-0.23)" fill="#5c5c5c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M292.15,429.78a8.88,8.88,0,0,0-17.74,0v49h17.74v-49Z" transform="translate(-0.23)"
              fill="#eefaf9" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#5c5c5c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M392.7,429.78a8.88,8.88,0,0,1,17.74,0v49H392.7v-49Z" transform="translate(-0.23)"
              fill="#eefaf9" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
          ...
          <g id="Hi-Hat" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M878.52,249h9.29v65.9h-9.29V249Z" transform="translate(-0.23)" fill="#bcece8"></path>
            <path
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#fde74c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M875.14,234.61h15.21" transform="translate(-0.23)" fill="none" stroke="#fef5b7"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"></path>
            ...
            <path d="M875.14,270.94h15.21" transform="translate(-0.23)" fill="none" stroke="#bead39"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" opacity="0.3"></path>


            <path d="M876,276.85h14.36V586.94H876V276.85Z" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M938.34,645.07l-56.78-56.78" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M828.76,645.07l54.75-54.84" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <circle cx="896.54" cy="416.69" r="8.45" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
            <path
          ...
          <g id="Tom-Left" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path d="M259.2,146.74H445.93V302.2H259.2V146.74Z" transform="translate(-0.23)" fill="#0F52BA"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M262.58,171.24h180" transform="translate(-0.23)" fill="none" stroke="#161E54"
              strokeMiterlimit="10" strokeWidth="8"></path>
            <path
              ...
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M320.88,173.77v-11" transform="translate(-0.23)" fill="#f8fdfd" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M327.64,197.43a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M383.4,173.77v-11" transform="translate(-0.23)" fill="#f8fdfd" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M390.16,197.43a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M251.59,146.74H452.68v17.74H251.59V146.74Z" transform="translate(-0.23)" fill="#f8fdfd"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M449.3,159.41H255" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M383.4,275.16v11" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M390.16,268.4a6.76,6.76,0,0,1-13.52,0v-16.9a6.76,6.76,0,1,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M320.88,275.16v11" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M327.64,268.4a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,1,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>


            <path d="M251.59,284.46H452.68V302.2H251.59V284.46Z" transform="translate(-0.23)" fill="#f8fdfd"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M449.3,298H255" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M432.83,237.14h-16a6.68,6.68,0,0,0,5.83,3.38H427A6.58,6.58,0,0,0,432.83,237.14Z"
              transform="translate(-0.23)" fill="#bcece8"></path>
            <path
            ...
            <path d="M483.36,227H426.07a6,6,0,0,0,5.49,3.38h46A6.08,6.08,0,0,0,483.36,227Z"
              transform="translate(-0.23)" fill="#bcece8"></path>
            <circle cx="477.8" cy="224.3" r="11.24" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
          ...
          <g id="Tom-Righ" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path d="M555.76,146.74H742.49V302.2H555.76V146.74Z" transform="translate(-0.23)" fill="#0F52BA"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M559.14,171.24h180" transform="translate(-0.23)" fill="none" stroke="#161E54"
              strokeMiterlimit="10" strokeWidth="8"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M617.44,173.77v-11" transform="translate(-0.23)" fill="#f8fdfd" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M624.2,197.43a6.76,6.76,0,0,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M680,173.77v-11" transform="translate(-0.23)" fill="#f8fdfd" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M686.73,197.43a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#f8fdfd" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M548.16,146.74H749.25v17.74H548.16V146.74Z" transform="translate(-0.23)" fill="#f8fdfd"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M745.87,159.41H551.54" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M680,275.16v11" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M686.73,268.4a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,1,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M617.44,275.16v11" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M624.2,268.4a6.76,6.76,0,1,1-13.52,0v-16.9a6.76,6.76,0,0,1,13.52,0v16.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>

            <path d="M548.16,284.46H749.25V302.2H548.16V284.46Z" transform="translate(-0.23)" fill="#f8fdfd"
              stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M745.87,298H551.54" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M568.78,237.14h16a6.68,6.68,0,0,1-5.83,3.38h-4.31A6.78,6.78,0,0,1,568.78,237.14Z"
              transform="translate(-0.23)" fill="#bcece8"></path>
            <path
            ...
            <path d="M518.25,227h57.29a6,6,0,0,1-5.49,3.38H524a6.16,6.16,0,0,1-5.75-3.38h0Z"
              transform="translate(-0.23)" fill="#bcece8"></path>
            <circle cx="523.34" cy="224.3" r="11.24" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
          ...
          <g id="Kick" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <circle cx="500.28" cy="489.77" r="177.43" fill="#0F52BA" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="8"></circle>
            <circle id="Inner-Drum-Wobble" cx="500.28" cy="489.77" r="170" fill="none"></circle>
            <circle id="Inner-Drum" cx="500.28" cy="489.77" r="162.73" fill="#fdfffc" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"></circle>
            ...
            <path d="M319.19,481.07a8.87,8.87,0,1,0,0,17.74v7.86h16.9v-33.8h-16.9v8.2Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="8"></path>
            ...
            <path d="M331,503.29v-27" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path d="M402.58,641.94a8.84,8.84,0,1,0,15.29,8.87l6.84,4,8.45-14.62-29.23-16.9-8.45,14.62Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="8"></path>
            <path
              d="M409.59,647.77a1.71,1.71,0,0,0,2.28-.59,1.67,1.67,0,0,0-2.87-1.69A1.57,1.57,0,0,0,409.59,647.77Z"
              transform="translate(-0.23)" fill="#333"></path>
            <path d="M427.84,642.87l-23.4-13.52" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <path d="M591.93,647.52a1.67,1.67,0,1,0-2.28-.59A1.68,1.68,0,0,0,591.93,647.52Z"
              transform="translate(-0.23)" fill="#333"></path>
            <path d="M596.74,629.35l-23.49,13.52" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>

            <path d="M680.81,498.48a8.87,8.87,0,1,0,0-17.74v-7.86h-16.9v33.8h16.9v-8.2Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="8"></path>
            <path d="M682.93,489.44a1.69,1.69,0,1,0-1.69,1.69A1.69,1.69,0,0,0,682.93,489.44Z"
              transform="translate(-0.23)" fill="#333"></path>
            <path d="M669,476.25v27" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#333"></path>
            <path d="M573.42,336.67l23.4,13.52" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path d="M417.7,328.82a8.84,8.84,0,1,0-15.29,8.87l-6.84,4L404,356.28l29.23-16.9-8.45-14.62Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="8"></path>
            <path
              d="M409.09,331.94a1.68,1.68,0,0,0-.59,2.28,1.67,1.67,0,0,0,2.87-1.69A1.64,1.64,0,0,0,409.09,331.94Z"
              transform="translate(-0.23)" fill="#333"></path>
            <path d="M404.27,350.19l23.49-13.52" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
          </g>
          ...
          <g id="Crash" onClick={(e) => { clickDom(e?.target.parentNode) }}>
            ...
            <path d="M173.78,121.64l17.15-47.15a4.64,4.64,0,1,0-8.7-3.21l-17.15,47.15Z" transform="translate(-0.23)"
              fill="#eefaf9" stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M188.48,88.61a7,7,0,0,0-4.14-9l-0.42-.17a7,7,0,0,0-9,4.14L119.87,235.11l13.52,4.9Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#fde74c" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M185.86,105.42l-21.71-7.86" transform="translate(-0.23)" fill="none" stroke="#fef5b7"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"></path>


            <path d="M118.94,238H133.3V583.56H118.94V238Z" transform="translate(-0.23)" fill="#eefaf9" stroke="#333"
              strokeLinecap="round" strokeLinejoin="round" strokeWidth="6"></path>
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M181.3,642.53l-56.78-56.78" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <path
              ...
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M71.71,642.53l54.75-54.84" transform="translate(-0.23)" fill="none" stroke="#bcece8"
              strokeMiterlimit="10" strokeWidth="4"></path>
            <path
            ...
            <circle cx="139.5" cy="413.31" r="8.45" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></circle>
            <path
            ...
            <path d="M115,237.82a11.41,11.41,0,1,1,11.41,11.41A11.36,11.36,0,0,1,115,237.82Z"
              transform="translate(-0.23)" fill="#eefaf9" stroke="#333" strokeLinecap="round"
              strokeLinejoin="round" strokeWidth="6"></path>
            <path d="M128.4,235a3.39,3.39,0,1,0,.76,4.73A3.38,3.38,0,0,0,128.4,235Z" transform="translate(-0.23)"
              fill="#333"></path>
          </g>
        </g>
